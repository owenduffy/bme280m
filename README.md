# A simple IoT temperature, humidity and pressure sensor for NodeMCU / Lua and submitting measurements by [MQTT API](https://en.wikipedia.org/wiki/MQTT).

![Block diagram](bme280m01.png "Block diagram")
